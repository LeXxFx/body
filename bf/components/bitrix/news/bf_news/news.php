...
<div id="wrapper" class="has-sidebar" role="main">
        <div class="inner">
            <div id="content" role="main">
                <div id="breadcumbs">
                    <a href="#">Главная</a><span class="sep">/</span><span class="current">Новости и акции</span>
                </div>
                ...
                <div class="panel-pager clearfix">
                    <div class="col-sm-12 col-pagination">
                        <div class="pagination">
                            ...
                            <a href="#">2</a>
                            <a href="#">3</a>
                            <a href="#" class="page-next">Следующая страница</a>
                        </div>
                    </div>
                </div>
            </div>
            <div id="sidebar">
                <aside>
                    <div class="ya-reviews">
                        ...
                        <a href="#">
                            <img src="/bitrix/templates/bf/demo/yandex.png" alt=""/>
                        </a>
                    </div>
                    <div class="social">
                        <div class="title">Мы в соцсетях</div>
                        <div class="wrap">
                            <img src="/bitrix/templates/bf/demo/vk.jpg" alt=""/>
                        </div>
                    </div>
                </aside>
            </div>
